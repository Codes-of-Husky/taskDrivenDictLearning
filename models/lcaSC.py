...
class lcaSC(object):
    def __init__(self, inputNode, dictionary, alpha, lr):
        ...
        self.potential_init = tf.random_uniform(actShape, 0, 1.*alpha, dtype=tf.float32)
        ...
        self.nnz = tf.count_nonzero(self.activation) / (num_class * batch * dict_size)
    ...
    def __call__(self, sess, feed_dict, max_iterations=100, verbose=False):
        ...
        for it in range(max_iterations):
            ...
            if(verbose):
                ...
                print(it, ": \trecon_error", recon_err, "\tl1_sparsity", l1_sparsity, "\tloss", loss, "\tnnz", nnz)
